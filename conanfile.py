...
class cobalt_base_conan_project(ConanFile):
    name = "cobalt_base"
    ...
    description = "modified `starboard` library from cobalt"
    topics = ('c++')
    ...
    exports_sources = ("LICENSE", "*.md", "include/*", "src/*",
                       ...
                       "third_party/*", "base/*", "build/*", "cobalt/*", "starboard/*")
    ...
    def package_info(self):
        #self.cpp_info.libs = ["cobalt_base"]
